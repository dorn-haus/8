...
in {
  ...
  descheduler.helm = ["https://kubernetes-sigs.github.io/descheduler" "0.32.0"];
  external-secrets.helm = ["https://charts.external-secrets.io" "0.12.1"];
  ...
  kubelet-csr-approver.helm = ["https://postfinance.github.io/kubelet-csr-approver" "1.2.4"];
  ...
  node-feature-discovery.helm = ["https://kubernetes-sigs.github.io/node-feature-discovery/charts" "0.17.0"];
  ...
  vector.helm = ["https://helm.vector.dev" "0.38.1"];
